...
<body page='lista'>   
            ...
            <tbody id='listaRegistrosBody'>
                ...
                while($registros = $dados->fetch(PDO::FETCH_ASSOC)) {
                    echo "<tr>
                            ...
                            <td>
                                <center>
                                    <a href='editarUsuario.php?adotanteID=".$registros['adotanteID']."'><button>Editar</button></a>
                                    <button onclick='confirmarExclusao(".$registros['adotanteID'].")' class='vermelho' >Deletar</button>
                                </center>
                            </td>
                        </tr>";
                }
    ...
    <script>
        ...
        function confirmarExclusao(adotanteID) {
            if (confirm("Tem certeza que deseja excluir este usuário?")) {
                window.location.href = 'excluirUsuario.php?adotanteID=' + adotanteID;
            }
        }
    </script>
<?php
